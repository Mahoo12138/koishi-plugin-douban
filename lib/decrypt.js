/**
 * @form https://github.com/acdzh/douban-book-api
 */
var i = 16;
var Q = 4096;
var p = {
...
function digest(kkk) {
    var a = i_i // 这些加密数据有用
    , s = a("11400714785074694791"), u = a("14029467366897019727"), c = a("1609587929392839161"), f = a("9650029242287828579"), l = a("2870177450012600261");
...
function multiply(k, t) {
    var e = k._a00, r = k._a16, n = k._a32, o = k._a48, i = t._a00, a = t._a16, s = t._a32, u = t._a48, c = e * i, f = c >>> 16;
    f += e * a;
    var l = f >>> 16;
    f &= 65535,
        f += r * i,
...
function rotl(t) {
    ...
    var r = this._a48 << 16 | this._a32, n = this._a16 << 16 | this._a00, o = r << t | n >>> 32 - t, i = n << t | r >>> 32 - t;
...
function Bt(t) {
    ...
    function b(n) {
        var o = n.offset, a = n.objInfo, s = (n.tableOffset,
            a), u = 1;
        if (15 == a) {
            var c = t[o + 1], f = (240 & c) / 16;
        ...
        if (2 * s * E > e.maxObjectSize)
            throw new Error(4);
        for (var p = {}, d = 0; d < s; d++) {
            var m = i_Bt(a_slice(t, o + u + d * E, o + u + (d + 1) * E)), y = i_Bt(a_slice(t, o + u + s * E + d * E, o + u + s * E + (d + 1) * E)), g = r(m), v = r(y);
            p[g] = v;
        }
        return p;
    }
    var w = a_slice(t, t.length - 32, t.length), _ = readUInt8.call(w, 6), E = readUInt8.call(w, 7), A = s_Bt(w, 8), C = s_Bt(w, 16), S = s_Bt(w, 24);
    for (var x = [], O = 0; O < A; O++) {
